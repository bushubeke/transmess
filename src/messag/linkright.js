...
class LinkRight extends React.Component {
  constructor(props){ 
    super(props);
    this.state = {
      tooltipshowE:false,
        ...
        <React.Fragment>
                   ...
                   <Col xs={1}>
                      ...
                      <Col xs={8} style={{backgroundColor:'#a1c2e3',borderRadius:'15px'}}>
                          ...
                          <Button  ref={this.EditPoperRef}  onMouseEnter={this.setTooltipShowE} onMouseLeave={this.setTooltipShowE} variant='outline-light' size='sm'className='icon-pos'>  
                          ...
                          <Button ref={this.DeletePoperRef}  onMouseEnter={this.setTooltipShowD} onMouseLeave={this.setTooltipShowD} variant='outline-light' size='sm' className='icon-pos'>
